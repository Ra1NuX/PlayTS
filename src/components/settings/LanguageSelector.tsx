...
const LanguageSelector = () => {
  ...
  return (
    <div className="flex flex-row gap-5 justify-between items-center">
      ...
      <ListboxButton className='dark:bg-main-dark/50 bg-[#fafafa] dark:hover:bg-main-dark hover:bg-[#f0f0f0] border shadow-md dark:border-main-dark/20 p-1 pr-2 rounded-xl flex justify-between min-w-[110px]'>
      ...
      <ListboxOptions anchor="bottom" className='z-20 dark:bg-main-light bg-[#f7f7f7] shadow-2xl border border-main-dark/20 rounded-lg mt-2'>
        {locales.map((locale) => (
