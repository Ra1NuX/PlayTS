          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                disabled={isLoading}
                className="flex items-center gap-1 dark:bg-main-dark bg-gray-100 hover:bg-gray-200 dark:hover:bg-main-dark/80 disabled:opacity-50 disabled:cursor-not-allowed dark:text-gray-300 text-main-dark border border-gray-300 dark:border-main-dark rounded-lg px-2 py-1 text-xs transition-all font-normal opacity-0 group-hover:opacity-100"
